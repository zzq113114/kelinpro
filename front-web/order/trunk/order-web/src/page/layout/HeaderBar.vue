<template>
    <div class="sys-header">
        ...
        <div class="userInfo">
            ...
            <ul>
                <li>
                    <iframe style="--font-color-base:#FF0000" frameborder="0" allowtransparency="true" src="http://i.tianqi.com/index.php?c=code&id=46&icon=5&num=2"></iframe>
                </li>
                <!--<li>-->
                    <!--&lt;!&ndash;<span class="user" command="APP">{{$t('global.APP')}}<i class="el-icon-caret-bottom el-icon&#45;&#45;right"></i></span>&ndash;&gt;-->
                <!--</li>-->
                <!--<li>-->
                    <!--<el-dropdown @command="userOperation">-->

                        <!--&lt;!&ndash; <span class="user">{{username}}<i class="el-icon-caret-bottom el-icon&#45;&#45;right"></i></span> &ndash;&gt;-->
                        <!--&lt;!&ndash;<span class="user">管理员<i class="el-icon-caret-bottom el-icon&#45;&#45;right"></i></span>&ndash;&gt;-->
                        <!--&lt;!&ndash;<el-dropdown-menu slot="dropdown">&ndash;&gt;-->
                            <!--&lt;!&ndash;<el-dropdown-item command="editPaw">{{$t('global.editpassword')}}</el-dropdown-item>&ndash;&gt;-->
                            <!--&lt;!&ndash;<el-dropdown-item command="logout">{{$t('global.logout')}}</el-dropdown-item>&ndash;&gt;-->
